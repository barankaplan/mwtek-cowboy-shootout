...
public final class ConsoleReporter {
    private static final String SHOOTOUT_STARTED_FORMAT =
            "Shootout started with %d %s%nStarting cowboy: %d%n";
    private static final String SHOT_FORMAT =
            "#%d Cowboy %d shoots %s at Cowboy %d; damage=%d, target HP=%d%s%n";
    ...
    private static final String WINNER_POSITION_FORMAT = """
            ...
            """;
    private static final String SOLE_COWBOY_EXPLANATION =
            "No shots were needed because Cowboy %d was the only participant.%n";
    ...
    public void reportShootoutStarted(int numberOfCowboys, int startingCowboyId) {
        ...
        System.out.printf(
                SHOOTOUT_STARTED_FORMAT, numberOfCowboys, cowboyWord, startingCowboyId);
    }
    ...
    public void reportShootoutCompleted(ShootoutResult shootoutResult) {
        ...
        System.out.printf(
                WINNER_FORMAT, winner.cowboyId(), winner.remainingHealthPoints());
