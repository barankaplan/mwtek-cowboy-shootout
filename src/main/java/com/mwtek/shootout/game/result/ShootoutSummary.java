...
public record ShootoutSummary(int numberOfCowboys, int startingCowboyId, int totalShots, Winner winner, WinnerStatistics winnerStatistics) {
    ...
    public WinnerPosition winnerPosition() {
        return WinnerPosition.calculate(numberOfCowboys, startingCowboyId, winner.cowboyId());
    }
}